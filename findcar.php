       ...
       <div class="col-md-12">
        <div class="section-title">
         ...
         <table width="100%" style="border: 1px solid red;">
          <thead>
            <tr>
              <th style="border: 1px solid red;width: 33.33%;">車牌</th>
              <th style="border: 1px solid red;width: 33.33%;">停放車格</th>
              <th style="border: 1px solid red;width: 33.33%;">入場時間</th>
            </tr>
          </thead>
          <tbody>
            <tr>
          <?php
            if(isset($_POST['License'])){
              ...
              while($row=mysqli_fetch_array($FindCar_result)){
                $Find=1;
                echo "<td style='border: 1px solid red;width: 33.33%;'>".$row['License']."</td>";
                echo "<td style='border: 1px solid red;width: 33.33%;'>".$row['SpaceID']."</td>";
                echo "<td style='border: 1px solid red;width: 33.33%;'>".$row['EnterTime']."</td>";

              }
              if($Find==0){//沒找到
                echo "<td colspan='3' style='border: 1px solid red;'>此車牌目前尚未無停車紀錄</td>";
              }
              echo "</tr>";
            }
            else{
